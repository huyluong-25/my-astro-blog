---
title: "Phần 7: Tính Từ (Adjectives) – Cách Sử Dụng & Các Mẹo Tránh Bẫy TOEIC Cực Chi Tiết"
description: "Cẩm nang toàn diện về Tính từ trong tiếng Anh: Cách nhận diện hậu tố/tiền tố, phân biệt tính từ đuôi -ed/-ing, 7 vị trí vàng trong câu và mẹo tránh bẫy TOEIC Part 5."
pubDate: 2026-06-06
order: 21
---
...
| Hậu tố | Ý nghĩa | Gốc từ $\rightarrow$ Tính từ | Ví dụ dịch nghĩa |
| :--- | :--- | :--- | :--- |
| **-able / -ible** | có thể | wash $\rightarrow$ **washable**<br>flex $\rightarrow$ **flexible** | có thể giặt<br>linh hoạt |
| **-al / -ial** | thuộc về | culture $\rightarrow$ **cultural**<br>finance $\rightarrow$ **financial** | thuộc về văn hóa<br>thuộc về tài chính |
| **-ful** | đầy, có | help $\rightarrow$ **helpful**<br>use $\rightarrow$ **useful** | có ích, hay giúp đỡ<br>hữu dụng |
| **-less** | không có | care $\rightarrow$ **careless**<br>use $\rightarrow$ **useless** | cẩu thả (không cẩn thận)<br>vô dụng |
| **-ic** | thuộc về | history $\rightarrow$ **historic**<br>art $\rightarrow$ **artistic** | mang tính lịch sử<br>mang tính nghệ thuật |
| **-ive / -ative** | có tính, xu hướng | create $\rightarrow$ **creative**<br>inform $\rightarrow$ **informative** | có tính sáng tạo<br>chứa nhiều thông tin |
| **-ous / -ious** | có tính chất | danger $\rightarrow$ **dangerous**<br>curiosity $\rightarrow$ **curious** | nguy hiểm<br>tò mò |
| **-y** | có nhiều, đặc điểm | noise $\rightarrow$ **noisy**<br>cloud $\rightarrow$ **cloudy** | ồn ào<br>nhiều mây |
...
| Tiền tố | Tính từ gốc $\rightarrow$ Tính từ phủ định | Ví dụ dịch nghĩa | Mẹo nhận biết thực chiến |
| :--- | :--- | :--- | :--- |
| **un-** | happy $\rightarrow$ **unhappy** | hạnh phúc $\rightarrow$ không hạnh phúc | Phổ biến nhất. |
| **in-** | correct $\rightarrow$ **incorrect** | đúng $\rightarrow$ không đúng | Thường đi với gốc từ gốc Latinh. |
| **im-** | possible $\rightarrow$ **impossible** | khả thi $\rightarrow$ bất khả thi | **Mẹo:** Thường đứng trước các từ bắt đầu bằng **p, b, m**. |
| **ir-** | regular $\rightarrow$ **irregular** | đều đặn $\rightarrow$ không đều | **Mẹo:** Chỉ đứng trước các từ bắt đầu bằng chữ **r**. |
| **il-** | legal $\rightarrow$ **illegal** | hợp pháp $\rightarrow$ bất hợp pháp | **Mẹo:** Chỉ đứng trước các từ bắt đầu bằng chữ **l**. |
...
*   **Phân tích:**
    1.  Chỗ trống đứng trước danh từ chỉ người `speaker` (diễn giả) $\rightarrow$ Cần một tính từ bổ nghĩa cho `speaker`. Loại C (danh từ) và D (động từ).
...
*   $\rightarrow$ **Đáp án đúng: B. boring**
...
*   **Phân tích:**
    1.  Chỗ trống đứng sau `were so` $\rightarrow$ Cần một tính từ đứng sau động từ to-be để bổ nghĩa cho chủ ngữ `instructions` (bản hướng dẫn - chỉ vật). Loại C (danh từ) và D (động từ).
...
*   $\rightarrow$ **Đáp án đúng: B. confusing**
...
| :--- | :--- | :--- | :--- |
| **1. Đứng trước Danh từ** | `Adj + N` | a **nice** house<br>**high** prices | Tính từ bổ nghĩa cho danh từ đứng ngay sau nó. |
| **2. Đứng sau Đại từ bất định** | `Đại từ bất định + Adj` | something **special**<br>anyone **new** | Các đại từ như *something, anyone, nothing...* có tính từ đi sau. |
| **3. Đứng sau Linking Verb** | `Linking Verb + Adj` | This tea tastes **strange**.<br>I am **hungry**. | Động từ liên kết gồm: *be, look, seem, become, feel, taste, get...* |
| **4. Tác động lên Tân ngữ** | `Make/Find/Keep + O + Adj` | He made me **angry**.<br>Keep the room **clean**. | Tính từ bổ nghĩa cho tân ngữ (O) đứng trước nó. |
...
| **7. Đủ / Quá** | `Adj + enough`<br>`Too + Adj` | old **enough**<br>too **small** | *Enough* đứng sau tính từ, còn *Too* đứng trước tính từ. |
...
*   **Mẹo 1:** Nhìn phía trước chỗ trống, nếu thấy các động từ liên kết: `be, look, seem, become, feel, remain` $\rightarrow$ **Ưu tiên chọn ngay Tính từ**.
*   **Mẹo 2:** Nhìn thấy cấu trúc: `Mạo từ (a / an / the) + [Chỗ trống] + Danh từ` $\rightarrow$ Chắc chắn chọn **Tính từ** để bổ nghĩa cho danh từ phía sau.
*   **Mẹo 3 (Mẹo từ Enough):** Hãy nhớ quy tắc vị trí của *Enough*:
    *   Đứng **SAU** tính từ: `Adj + enough` (VD: *good enough*).
    *   Đứng **TRƯỚC** danh từ: `enough + N` (VD: *enough money*).
...
**1. C – interesting**
- **Giải thích:** Áp dụng cấu trúc `Find + O + Adj`. Ở đây, tân ngữ là "the marketing proposal" (chỉ vật - bản đề xuất tiếp thị). Bản đề xuất này có bản chất là **gây ra** sự thích thú, nên ta dùng tính từ chủ động đuôi **-ing** $\rightarrow$ chọn **interesting**.

**2. A – pleased**
- **Giải thích:** Chủ ngữ là "The supervisor" (người giám sát - chỉ người). Người giám sát này nhận được sự **cảm nhận/hài lòng** (bị động) từ hành động của đội thực tập $\rightarrow$ dùng tính từ bị động đuôi **-ed** $\rightarrow$ chọn **pleased** (hài lòng).

**3. C – comprehensive**
- **Giải thích:** Chỗ trống đứng trước danh từ "matter" $\rightarrow$ loại D (afraid chỉ đứng sau động từ). Gốc nghĩa của câu: bàn bạc một vấn đề "toàn diện/bao quát" trước cuộc họp ngân sách $\rightarrow$ chọn **comprehensive**. (B. *main* không phù hợp ngữ nghĩa trong ngữ cảnh này bằng comprehensive).

**4. B – significant**
- **Giải thích:** Khoảng trống đứng giữa mạo từ `a` và danh từ `increase` $\rightarrow$ theo công thức vàng, vị trí này cần một **Tính từ** để bổ nghĩa cho danh từ. Tính từ ở đây là **significant** (đáng kể).

**5. C – broken**
- **Giải thích:** Bổ nghĩa cho danh từ "machinery" (máy móc) $\rightarrow$ cần tính từ. Máy móc ở trạng thái "bị hỏng" $\rightarrow$ chọn tính từ phân từ bị động đặc biệt là **broken** (không có dạng *breaking machinery* trong trường hợp này vì máy móc không tự làm hỏng cái khác).

**6. B – easy**
- **Giải thích:** Áp dụng cấu trúc `Make + O + Adj` (Làm cho cái gì thế nào). Tân ngữ là cụm danh động từ "finding product information", do đó chỗ trống cần điền một **Tính từ** $\rightarrow$ chọn **easy**.

**7. C – totally**
- **Giải thích:** Chỗ trống đứng trước tính từ phân từ `completed` để bổ nghĩa cho nó $\rightarrow$ ta cần một **Trạng từ** (Adv) bổ nghĩa cho Adj $\rightarrow$ chọn **totally**. (A. *total* là tính từ chỉ đứng trước danh từ, không đứng trước bổ nghĩa cho tính từ khác độc lập như thế này).
...
**9. C – detailed**
- **Giải thích:** Chỗ trống đứng trước danh từ `explanations` $\rightarrow$ cần một tính từ bổ nghĩa. "Detailed" (chi tiết) là tính từ phân từ đuôi `-ed` cố định mang nghĩa "đầy đủ chi tiết" $\rightarrow$ chọn **detailed**.

**10. A – experienced**
- **Giải thích:** Đứng trước danh từ "candidate" (ứng viên) chỉ người $\rightarrow$ cần tính từ. Ứng viên "giàu kinh nghiệm" $\rightarrow$ dùng tính từ dạng phân từ cố định là **experienced** (có kinh nghiệm).
...
| **V-ed vs V-ing** | `V-ing` = chủ động, bản chất gây ra.<br>`V-ed` = bị động, cảm nhận của người. |
